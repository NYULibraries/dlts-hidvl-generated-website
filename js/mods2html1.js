...
function toggleSubtitle(st_id,classname){
  st = document.getElementsByClassName(classname);
  for(i = 0; i < st.length; i++){
  alert(st[i].id);
     st[i].style.backgroundColor='black';
  }
  document.getElementById(st_id).style.backgroundColor = 'gray';
}
