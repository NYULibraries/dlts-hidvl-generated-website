flowplayer("player", "http://dlibtest.home.nyu.edu/hidvl_site/util/fp/subtitle_test/flash/flowplayer/flowplayer.swf", {
    ...
    clip: {
        ...
        captionUrl: 'http://dlibtest.home.nyu.edu/hidvl_site/subtitles/Anabelle.srt',
        provider: 'rtmp',
        scaling: 'uniform',
        autoPlay: false,
        bitrates: [
            { url: 'mp4:003674785_300k_s.mp4', width: 448, height: 336, bitrate: 300, isDefault: true },
            { url: 'mp4:003674785_800k_s.mp4', width: 640, height: 480, bitrate: 800 }
        ]
    },
