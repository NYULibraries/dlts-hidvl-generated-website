var thePlayer = $f("player", "http://hidvl.nyu.edu/util/players/fp/standard/flowplayer.commercial.swf", {
    ...
    clip: {
        ...
        autoPlay: false,
        bitrates: [
            { url: 'mp4:000001514_300k_s.mp4', width: 448, height: 336, bitrate: 300, isDefault: true },
            { url: 'mp4:000001514_800k_s.mp4', width: 640, height: 480, bitrate: 800 }
        ]
    },
    ...
    plugins: {
        ...
        bwcheck: {
            ...
            netConnectionUrl: 'rtmp://stream1.dlib.nyu.edu/hidvl_r'
        },
